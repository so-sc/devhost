        ...
        <div className="events-holder">
          ...
          <ScrollAnimation animateIn="fadeIn">
            <EventCard
              ...
              speakerImage={data.jehad.childImageSharp.gatsbyImageData}
          ...
          <ScrollAnimation animateIn="fadeIn">
            <EventCard
              ...
              type="Talk"
              speaker="Madhu Akula"
              speakerImage={data.madhu.childImageSharp.gatsbyImageData}
          ...
          <ScrollAnimation animateIn="fadeIn">
            <EventCard
              ...
              speakerImage={data.sid.childImageSharp.gatsbyImageData}
          ...
          <ScrollAnimation animateIn="fadeIn">
            <EventCard
              ...
              type="Workshop"
              speaker="Sam Poder"
              speakerImage={data.sam.childImageSharp.gatsbyImageData}
          ...
          <ScrollAnimation animateIn="fadeIn">
            <EventCard
              ...
              speakerImage={data.siddharth.childImageSharp.gatsbyImageData}
          ...
          <ScrollAnimation animateIn="fadeIn">
            <EventCard
              ...
              speakerImage={data.sc.childImageSharp.gatsbyImageData}
