  ...
  return (
    <section className="speakers">
      <Container>
        ...
        <SpeakerCard
          image={data.madhu.childImageSharp.gatsbyImageData}
        ...
        />
        <SpeakerCard
          image={data.sid.childImageSharp.gatsbyImageData}
        ...
        />
        <SpeakerCard
          image={data.sam.childImageSharp.gatsbyImageData}
        ...
        />
        <SpeakerCard
          image={data.siddharth.childImageSharp.gatsbyImageData}
        ...
        />
        <SpeakerCard
          image={data.jehad.childImageSharp.gatsbyImageData}
